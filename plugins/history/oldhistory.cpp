...
void OldHistory::handle()
{
	if(!detect())
		return;

	int reply = KMessageBox::questionYesNo(Kopete::UI::Global::mainWidget(),
		...
		i18n( "History Plugin" ),
		KGuiItem( i18n("Import && Convert") ),
		KGuiItem( i18n("Do Not Import") ) );

	if(reply == KMessageBox::Yes)
		convert();
}

void OldHistory::convert()
{
